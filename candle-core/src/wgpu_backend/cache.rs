...
pub(crate) struct BindgroupLayouts {
    ...
    pub bind_group_layout1_8: wgpu::BindGroupLayout,
    ...
    pub pipeline_layout1_8: wgpu::PipelineLayout,
...
impl BindgroupLayouts {
    pub(crate) fn new(dev: &wgpu::Device) -> Self {
        ...
        let dest_entry_8 = wgpu::BindGroupLayoutEntry {
            binding: 0,
            visibility: wgpu::ShaderStages::COMPUTE,
            ty: wgpu::BindingType::Buffer {
                ty: wgpu::BufferBindingType::Storage { read_only: false },
        ...
        let input1_entry_8 = wgpu::BindGroupLayoutEntry {
            binding: 2,
            visibility: wgpu::ShaderStages::COMPUTE,
            ty: wgpu::BindingType::Buffer {
                ty: wgpu::BufferBindingType::Storage { read_only: true },
        ...
        let bind_group_layout1_8 = dev.create_bind_group_layout(&BindGroupLayoutDescriptor {
            label: None,
            entries: &[dest_entry_8, meta_entry, input1_entry],
        });
        ...
        let pipeline_layout1_8 = dev.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: None,
            bind_group_layouts: &[&bind_group_layout1_8],
            push_constant_ranges: &[],
        });
...
pub enum BindgroupInputBase<T> {
    Bindgroup0,                //
    Bindgroup1(T, bool, bool), //input1, is_16, is_8
    ...
    pub(crate) fn get_bind_group(
        ...
        fn check_buffer_reference(
            ...
            match &bindgroup_reference.1 {
                ...
                BindgroupInputBase::Bindgroup1(v1, is_16, is_8) => {
                    BindgroupInputBase::Bindgroup1(check_buffer(v1), *is_16, *is_8)
                }
        ...
        fn get_buffer_referece_key(
            ...
            return BindgroupFullBase(
                ...
                match &bindgroup_reference.1 {
                    BindgroupInputBase::Bindgroup0 => BindgroupInputBase::Bindgroup0,
                    BindgroupInputBase::Bindgroup1(v1, is_16, is_8) => {
                        BindgroupInputBase::Bindgroup1(get_storage(cache, v1), *is_16, *is_8)
                    }
                    BindgroupInputBase::Bindgroup2(v1, v2, is_16) => {
